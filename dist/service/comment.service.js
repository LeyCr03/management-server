...
let CommentService = class CommentService {
    ...
    userService;
    pollService;
    constructor(commentRepository, userService, pollService) {
    ...
    async findbyUserName(userName) {
        return this.commentRepository.findOne({ where: { userName } });
    }
    async createComment(createCommentDto) {
        const userId = createCommentDto.userId;
        const pollId = createCommentDto.pollId;
        ...
        const newComment = this.commentRepository.create({
            ...createCommentDto, user, poll, userName: user.name
        });
