...
const sub_service_1 = require("../service/sub.service");
let SubController = class SubController {
    subService;
    constructor(subService) {
        this.subService = subService;
    }
    async createSub(req, id) {
        return this.subService.createSub(req.user.user_id, id);
    }
    async deleteSub(id) {
        return this.subService.deleteSub(id);
    }
};
...
], SubController.prototype, "createSub", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SubController.prototype, "deleteSub", null);
exports.SubController = SubController = __decorate([
    (0, swagger_1.ApiTags)('Subs'),
    (0, common_1.Controller)('api/subs'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('accessToken'),
    __metadata("design:paramtypes", [sub_service_1.SubService])
], SubController);
