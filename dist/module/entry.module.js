...
const entry_controller_1 = require("../controller/entry.controller");
...
exports.EntryModule = EntryModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([entry_entity_1.Entry, account_entity_1.Account]),
        ],
        controllers: [entry_controller_1.EntriesController],
